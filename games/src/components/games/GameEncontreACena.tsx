...
const ROUNDS: Round[] = [
  ...
  { dica: 'Onde está o grande cajado de Davi?', tiles: [{ id: 'davi', label: 'Cajado' }, { id: 'moises', label: 'Mar aberto' }, { id: 'paulo', label: 'Carta' }], certo: 'davi', ref: '1 Samuel 17.40 (NAA)', msg: 'Davi usou um cajado e cinco pedras para vencer o Gigante Golias! 🪨' },
  { dica: 'Toque no mar que se abriu!', tiles: [{ id: 'moises', label: 'Mar aberto' }, { id: 'davi', label: 'Cajado' }, { id: 'eliseu', label: 'Manto' }], certo: 'moises', ref: 'Êxodo 14.21 (NAA)', msg: 'Moisés ergueu o bastão e o mar se abriu! 🌊' },
  { dica: 'Onde está o fogo do céu do Elias?', tiles: [{ id: 'elias', label: 'Fogo' }, { id: 'eliseu', label: 'Manto' }, { id: 'paulo', label: 'Carta' }], certo: 'elias', ref: '1 Reis 18.38 (NAA)', msg: 'O fogo desceu do céu e provou que Deus é Deus! 🔥' },
  { dica: 'Toque no manto do Eliseu!', tiles: [{ id: 'eliseu', label: 'Manto' }, { id: 'elias', label: 'Fogo' }, { id: 'natal', label: 'Estrela' }], certo: 'eliseu', ref: '2 Reis 2.13 (NAA)', msg: 'Eliseu recebeu o manto de Elias e fez muitos milagres! ✨' },
  { dica: 'Onde está a carta de Paulo?', tiles: [{ id: 'paulo', label: 'Carta' }, { id: 'moises', label: 'Mar aberto' }, { id: 'davi', label: 'Cajado' }], certo: 'paulo', ref: 'Efésios 2.8 (NAA)', msg: 'Paulo escreveu cartas cheias de amor para as igrejas! 📖' },
  { dica: 'Toque no peixe grande do Jonas de novo!', tiles: [{ id: 'paulo', label: 'Carta' }, { id: 'jonas', label: 'Peixe' }, { id: 'eliseu', label: 'Manto' }], certo: 'jonas', ref: 'Jonas 1.17 (NAA)', msg: 'Jonas aprendeu que Deus nunca desiste de nós! 💛' },
